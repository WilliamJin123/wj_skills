...
**Watch for:** a one-sentence paragraph that restates the paragraph before it; "That is the real win."; "Read that again."; "Let that sink in."; the same closer after several sections; a row of fragments ("No aesthetic prior. No nostalgia."); one word in ALL CAPS or with periods between words (every. single. day.); a colon reveal ("The best part: it learns."); commentary that tells the reader what to notice ("This distinction matters.", "The key point is", "As you can see", "That last part matters more than it sounds")
**Problem:** The line asks the reader to pause on a claim instead of adding to it. A colon reveal stages a plain fact as a twist; write it as a plain sentence and keep colons for lists, labels, and quotes. Commentary on the point says it matters instead of showing why; delete it, or replace it with the fact that shows why. One short sentence can carry emphasis when it carries a new fact. Cut a closer that repeats. Merge a row of fragments into a sentence with a specific claim.
**Before:**
...
>
> Retries hide brief outages.
**Before (colon reveal and commentary):**
> The detail that makes it work: a separate agent grades every draft. This distinction matters.
**After:**
> A separate agent grades every draft.
...
**Watch for:** Let's dive in, let's explore, let's break this down, here's what you need to know, now let's look at, without further ado, heads up, quick note, Honestly?, Look, Here's the thing, The thing is, Let's be honest, Real talk; faux-insight setups such as What most people get wrong, Here's what nobody tells you, This is the part most people skip, The part everyone misses; and casual versions such as "one thing that bit me, so pay attention"
**Problem:** The writer announces the point or stages a moment of candor instead of making the point. Remove the run-up, not just its tone. A faux-insight setup also casts the writer as the lone expert; cut it and let the claim stand. "Honestly" or "look" inside a casual sentence is ordinary; the tell is the standalone opener before a routine claim.
**Before:**
> Let's dive into how caching works in Next.js. Here's what you need to know.
**After:**
> Next.js caches data at multiple layers, including request memoization, the data cache, and the router cache.
**Before (faux insight):**
> Here's what nobody tells you about cold email: deliverability matters more than copy.
**After:**
> In cold email, deliverability matters more than copy.
